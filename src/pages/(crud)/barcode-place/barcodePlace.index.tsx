...
import { BarcodePlaceForm } from './BarcodePlaceForm'

const columnHelper = createColumnHelper<BarcodePlacePayload>()

const BarcodePlaceContent = () => {
  ...
  return (
    <div>
      ...
      <div className="card">
        <div className="p-4">
          <CommonFilterSearch name="place" placeholder="Search Barcode Place..." />
        </div>
      ...
      <CommonFormElement form={BarcodePlaceForm} />
    </div>
  )
}

const BarcodePlace = withModuleProvider(BarcodePlaceContent, 'barcode-place')
export default BarcodePlace
