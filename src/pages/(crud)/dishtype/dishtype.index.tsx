...
const columnHelper = createColumnHelper<DishTypePayload>()

const DishTypeContent = () => {
  ...
  return (
    <div>
      ...
      <div className="card">
        <div className="p-4">
          <CommonFilterSearch name="name" placeholder="Search Dish Type..." />
        </div>
      ...
      <CommonFormElement form={DishTypeForm} />
    </div>
  )
}

const DishType = withModuleProvider(DishTypeContent, 'dishtype')
