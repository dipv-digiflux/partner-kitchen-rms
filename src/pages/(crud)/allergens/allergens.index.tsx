...
const columnHelper = createColumnHelper<AllergensPayload>()
...
const AllergensContent = () => {
  ...
  return (
    <div>
      ...
      <div className="card">
        <div className="p-4">
          <CommonFilterSearch name="name" placeholder="Search Allergens..." />
        </div>
      ...
      <CommonFormElement form={AllergensForm} />
    </div>
  )
}

const Allergens = withModuleProvider(AllergensContent, 'allergens')
